...
import { ReaderToolbar, type NavItem } from "./reader-toolbar";
...
export function EpubReader({
  ...
  const updateSettings = (newSettings: Partial<ReaderSettings>) => {
    ...
    // Only apply CSS settings if layout hasn't changed (layout change triggers useEffect)
  ...
  const navigateTo = (href: string) => renditionRef.current?.display(href);

  const handleCenterTap = (e: React.MouseEvent) => {
    // In scrolled mode, only toggle toolbar, don't tap to page
